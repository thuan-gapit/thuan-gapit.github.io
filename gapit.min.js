...
(function () {
    ...
    var listenerMessageSite = function ($this) {
    ...
    var renderHtmlFromConfig = function (formHTML, config, options) {
        var contentPopup;
        var cssPopup;
        var { title, description, style, zalo } = options.formConfig;
        ...
        var renderHtmlIframe = `
            ...
            ${zalo.isExist === true ? `<script src="https://sp.zalo.me/plugins/sdk.js"></script>` : ''}
            <script>
                ...
                (function() {
                    ...
                    window.onmessage = function (e) {
                        ...
                        if (type == '${windownMessType.messageSuccess}') {
                            document.querySelector('form').innerHTML = 
                            "<div> <h3>" + payload.title + "</h3> <div>" + payload.description + "</div> </div>";
                        }
                    }
    ...
    var presentProcess = async function (options) {
        ...
        // create html
        options.src = renderHtmlFromConfig(form.outerHTML, options.formConfig, options);
        return options;
    }
    ...
    GapitScript.reRender = async function (options) {
        ...
        // Get config from server then render it
        options = await presentProcess(options);
        document.getElementById('gapit-iframe').srcdoc = options.src;
    }
}());
// End Generate Iframe
