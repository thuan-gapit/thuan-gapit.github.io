...
(function () {
            ...
            var showFollowTarget = function (fn, showOption) {
                var checkMatchingAndContain = function (showContain = []) {
                    ...
                    for (var ele in showContain) {
                        ...
                        else if (ele.Matching && window.location.href == ele.Matching) {
                            result = true;
                            break;
                        }
                    }
    ...
    GapitScript.reRender = async function (options) {
        options.extend({
            ...formType,
            getConfig: `http://localhost:8016/push/signup-form/?userId=8&formId=6`,
        })
    ...
    GapitScript.init = async function (options) {
        options.extend({
            ...formType,
            getConfig: `http://localhost:8016/push/signup-form/?userId=${options.userId}&formId=${options.formId}`
        })
        options = await presentProcess(options);
...
(function (d, s, id) {
    ...
    link.rel = 'stylesheet';
    link.type = 'text/css';
    link.href = 'https://dev-thuannv.gapone.vn/css/gapit.min.css';
