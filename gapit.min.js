...
(function () {
    ...
    var listenerMessageSite = function ($this, getDataSuccess) {
    ...
    var insertModal = function ($this) {
        ...
        (function () {
            ...
            listenerMessageSite($this, getDataSuccess);
        }());
    },
    ...
    var renderHtmlFromConfig = function (formHTML, config, options) {
        var contentPopup;
        var cssPopup;
        var { title, description, style, zalo, messageSuccess } = options.formConfig;
        if (options.isShowThanks == true) {
            formHTML = '<div> <h3 class="success-title">' + messageSuccess.title + '</h3> <div class="success-des">' + messageSuccess.description + "</div> </div>";
        }
        else {
        ...
        if (style.backgroundImage) {
            renderBackground = `background-image: url(${style.backgroundImage})`;
        }
        var renderHead = `
        <head>
                <style>
                ...
                (function() {
                    window.onmessage = function (e) {
                        ...
                        switch (type) {
                            case "${windownMessType.reRenderIframe}": 
                                var {headHTML, src, isLoadElement, isLoadZalo} = payload;
                            ...
                            case "${windownMessType.messageSuccess}": 
                                ...
                                '<div> <h3  class="success-title">' + payload.title + '</h3> <div class="success-des">' + payload.description + "</div> </div>";
                    ...
                    window.addEventListener('DOMContentLoaded', function (e) {
                        window.top.postMessage({
                            type: '${windownMessType.resizeIframe}',
                            payload: {
                                height: document.body.scrollHeight + ${zalo.isExist == true ? 20 : 0}
                            }
                        }, '*')
                    });
                }());
    ...
    var presentProcess = async function (options) {
        ...
        // create html
        var renderResultHTML = renderHtmlFromConfig(form.outerHTML, options.formConfig, options);
        options.extend({
            src: renderResultHTML.src,
            headHTML: renderResultHTML.headHTML
        })
        return options;
    }
