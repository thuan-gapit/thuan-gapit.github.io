...
(function () {
    ...
    var visibilityContent = function (_this, payload) {
        ...
        document.querySelector(`#${_this.element.id} .gapit-content`).style.extend({
    ...
    var insertModal = function (_this) {
        ...
        (function () {
            var getDataSuccess = function (data) {
                ...
                if (_this.options.formConfig.show_option.display_frequency.show_again) {
                    setCookie('isSubmmitFormSignup', true, _this.options.formConfig.show_option.display_frequency.show_again * 24 * 60);
                }
                else {
                    setCookie('isSubmmitFormSignup', true);
                }
                setTimeout(() => {
                    closeModal(_this);
                }, 1000)
        ...
        attachEventListeners = function (_this) {
            ...
            var onShow = function () {
                ...
                sessionStorage.setItem("GPPopupLookUp", true);
            }
            //fadeIn.display(onShow, 1000);

            var showFrequency = function (fn, displayFrequency) {
                var isSubmmit = getCookie('isSubmmitFormSignup');
                if (!isSubmmit || isSubmmit === false) {
                    var isLookUp = sessionStorage.getItem("GPPopupLookUp");
            ...
            var showFollowTarget = function (fn, showOption) {
                ...
                var { target, display_frequency } = showOption;
                ...
                if (show_contain && show_contain.length > 0) {
                    ...
                    if (isShow === true) {
                        ...
                        if (not_show_contain && not_show_contain.length > 0) {
                            ...
                            if (isNotShow !== true) {
                                showFrequency(fn, display_frequency);
                            }
                        }
                        else {
                            showFrequency(fn, display_frequency);
    ...
    GapitScript.reRender = async function (options) {
        options.extend({
            ...formType,
            getConfig: `${GapitUrl.config}?formId=${options.formId}`,
        })
    ...
    GapitScript.renderThanks = async function (options) {
        options = await presentProcess(options);
        this.element = document.getElementById(options.elementId);
        ...
        if (this.element && !document.querySelector(`#${this.element.id} iframe`)) {
            ...
            document.querySelector(`#${this.element.id} .gapit-content`).style.extend({
                visibility: 'visible'
            });
        }
        else {
