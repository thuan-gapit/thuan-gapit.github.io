    ...
    window.hbspt.forms.deps.React ? this.React = window.hbspt.forms.deps.React : function(e) {
        ...
        return function e(t, n, i) {
            ...
            3: [function(e, t, n) {
                ...
                function c(e, t, n, i) {
                    var a, c;
                    if (S ? a = r(e) : O ? s(e, i) && (a = N.compositionEnd) : o(e, i) && (a = N.compositionStart), !a) return null;
                    I && (O || a !== N.compositionStart ? a === N.compositionEnd && O && (c = O.getData()) : O = g.getPooled(t));
            ...
            7: [function(e, t, n) {
                ...
                function u(e, t) {
                    N = e, R = t, O = e.value, w = Object.getOwnPropertyDescriptor(e.constructor.prototype, "value"), Object.defineProperty(N, "value", A), N.attachEvent("onpropertychange", d)
                }

                function p() {
                    N && (delete N.value, N.detachEvent("onpropertychange", d), N = null, R = null, O = null, w = null)
                }
                ...
                function h(e, t, n) {
                    return e !== D.topSelectionChange && e !== D.topKeyUp && e !== D.topKeyDown || !N || N.value === O ? void 0 : (O = N.value, R)
                }
                ...
                var L = !1;
                E.canUseDOM && (L = T("input") && (!("documentMode" in document) || document.documentMode > 9));
                var A = {
                        get: function() {
                            return w.get.call(this)
                        },
                        set: function(e) {
                            O = "" + e, w.set.call(this, e)
                        }
                    },
                    F = {
                        eventTypes: _,
                        extractEvents: function(e, t, n, a) {
                            var r, o;
                            if (i(t) ? M ? r = l : o = c : I(t) ? L ? r = f : (r = h, o = m) : g(t) && (r = v), r) {
                                var s = r(e, t, n);
                                if (s) {
            ...
            33: [function(e, t, n) {
                ...
                function i(e, t) {
                    ...
                    C.hasOwnProperty(t) && b(n === S.OVERRIDE_BASE), e.hasOwnProperty(t) && b(n === S.DEFINE_MANY || n === S.DEFINE_MANY_MERGED)
                }
                ...
                o.displayName = "ReactDOMComponent", o.Mixin = {
                    ...
                    _updateDOMProperties: function(e, t) {
                        ...
                        for (n in e)
                            if (!o.hasOwnProperty(n) && e.hasOwnProperty(n))
                                ...
                                } else E.hasOwnProperty(n) ? x(this._rootNodeID, n) : (l.isStandardName[n] || l.isCustomAttribute(n)) && I.deletePropertyByID(this._rootNodeID, n);
                        for (n in o) {
                            var c = o[n],
                            ...
                            else E.hasOwnProperty(n) ? a(this._rootNodeID, n, c, t) : (l.isStandardName[n] || l.isCustomAttribute(n)) && I.updatePropertyByID(this._rootNodeID, n, c)
                        }
                    ...
                    _updateDOMChildren: function(e, t, n) {
                        var i = this._currentElement.props,
                            ...
                            u = null != a || null != o,
                            p = null != r || null != s;
                        null != l && null == c ? this.updateChildren(null, t, n) : u && !p && this.updateTextContent(""), null != r ? a !== r && this.updateTextContent("" + r) : null != s ? o !== s && I.updateInnerHTMLByID(this._rootNodeID, s) : null != c && this.updateChildren(c, t, n)
                    },
                    unmountComponent: function() {
            ...
            54: [function(e, t, n) {
                ...
                function a() {
                    R.EventEmitter.injectReactEventListener(N), R.EventPluginHub.injectEventPluginOrder(l), R.EventPluginHub.injectInstanceHandle(O), R.EventPluginHub.injectMount(w), R.EventPluginHub.injectEventPluginsByName({
                        SimpleEventPlugin: F,
                    ...
                    }), R.NativeComponent.injectGenericComponentClass(v), R.NativeComponent.injectTextComponentClass(D), R.NativeComponent.injectAutoWrapper(i), R.Class.injectMixin(f), R.NativeComponent.injectComponentClasses({
                        button: b,
                        form: x,
                        iframe: S,
                        img: y,
                        ...
                        head: P("head"),
                        body: P("body")
                    }), R.DOMProperty.injectDOMPropertyConfig(p), R.DOMProperty.injectDOMPropertyConfig(j), R.EmptyComponent.injectEmptyComponent("noscript"), R.Updates.injectReconcileTransaction(M), R.Updates.injectBatchingStrategy(g), R.RootIndex.injectCreateReactRootIndex(u.canUseDOM ? s.createReactRootIndex : A.createReactRootIndex), R.Component.injectEnvironment(h), R.DOMComponent.injectIDOperations(E)
                }
                var r = e(3),
                    o = e(7),
                    s = e(8),
            ...
            68: [function(e, t, n) {
                ...
                function c(e) {
                    ...
                    return x.isNullComponentID(t) ? null : (F.hasOwnProperty(t) && u(F[t], t) || (F[t] = H.findReactNodeByID(t)), F[t])
                }
                ...
                function s(e, t, n, i, r) {
                    ...
                    if (Array.isArray(e))
                        ...
                        if (b) {
                            ...
                            f(1 !== e.nodeType);
                            var k = u.extract(e);
                            for (var T in k) k.hasOwnProperty(T) && (g += s(p = k[T], ("" !== t ? t + h : m) + o(T) + h + a(p, 0), n + g, i, r))
                        }
                    }
                    return g
                }
...
! function(e, t) {
    ...
    var t = "function" == typeof e,
        ...
        N = function(e, t) {
            return '<table cellpadding="0" cellspacing="0" class="pika-table">' + D(e) + C(t) + "</table>"
        },
        R = function(o) {
            var s = this,
                l = s.config(o);
    ...
    e.exports = {
        "fr-ca": {
            formsNext: {
                ...
                phoneInvalidRangeTooShort: "Veuillez entrer un numéro de téléphone d'au moins {{ min }} chiffres.",
                phoneInvalidRangeTooLong: "Veuillez entrer un numéro de téléphone qui ne comporte pas plus {{ max }} de chiffres.",
    ...
    e.exports = {
        lt: {
            formsNext: {
                ...
                phoneInvalidRangeTooShort: "Įveskite telefono numerį, kuris būtų sudarytas bent iš {{ min }} skaitm.",
                phoneInvalidRangeTooLong: "Įveskite telefono numerį, kuris būtų sudarytas iš ne daugiau kaip {{ max }} skaitm.",
    ...
    e.exports = {
        "pt-pt": {
            formsNext: {
                ...
                phoneInvalidRangeTooShort: "Introduza um número de telefone que tenha, pelo menos, {{ min }} números de comprimento.",
                phoneInvalidRangeTooLong: "Introduza um número de telefone que tenha, pelo menos, {{ max }} número de comprimento.",
...
! function() {
    ...
    e.exports = {
        pt: {
            formsNext: {
                ...
                emailOptIn: "Verifique o seu e-mail para escolher regressar.",
                resubscribeMessage: "Aparentemente, optou por não receber comunicações por e-mail. Clique aqui para obter um e-mail e optar por regressar.",
                invalidDate: "Utilize o selecionador de data para corresponder ao formato AAAA-MM-DD.",
                phoneInvalidCharacters: "Só pode conter números, +()-. e x.",
                phoneInvalidCharactersWithoutCountryCode: "Só pode conter números, ()-. e x.",
                phoneInvalidRangeTooShort: "Introduza um número de telefone que tenha, pelo menos, {{ min }} números de comprimento.",
                phoneInvalidRangeTooLong: "Introduza um número de telefone que tenha, pelo menos, {{ max }} número de comprimento.",
    ...
    hns("I18n", t);
    "object" == typeof I18n && I18n.trigger && I18n.trigger("loaded:FormsNext:pt", {
        version: "static-5.333"
    })
}();
! function() {
    ...
    e.exports = {
        sk: {
            formsNext: {
                ...
                phoneInvalidRangeTooLong: "Zadajte telefónne číslo, ktoré má dĺžku maximálne {{ max }} číslic.",
...
! function() {
    var e, t, n, i, a, r, o, s, l, c, u, p = [].indexOf || function(e) {
    ...
    r = ["'andale mono', times", "arial, helvetica, sans-serif", "'book antiqua', palatino", "'courier new', courier", "georgia, palatino", "helvetica", "impact, chicago", "symbol", "tahoma, arial, helvetica, sans-serif", "terminal, monaco", "'times new roman', times", "'trebuchet ms', geneva", "verdana, geneva"];
    o = function(e, t) {
        var n, i, a, r, o;
        a = e.map(function(e) {
            return e.value
        ...
        for (n = 0, i = t.length; n < i; n++) {
            o = t[n];
            if (r = u.trim(o), p.call(a, r) < 0) return !1
        }
        return !0
    };
    ...
    if (!(u = {
            ...
            getSelectedOptionsByLabel: function(e, t) {
                ...
                return (a = (r = o(s, i) ? i : n).map((l = this, function(t) {
                    var n;
            ...
            filterDependentField: function(e, t, n, i, a) {
                var r, o, s, l, c, u, p, d, f, m;
                switch (t) {
                    case "enumeration":
                    ...
                    case "datetime":
                        ...
                        if ("WITHIN_TIME" === (d = i.operator) || "WITHIN_TIME_REVERSE" === d) {
                            m = new Date;
                            "w" === i.strValues[1] ? m.setDate(m.getDate() - 7 * i.strValues[0]) : m.setDate(m.getDate() - i.strValues[0]);
                            m = m.getTime();
                            return hubspot.operators[i.operator](s, m)
                        }
                        r = new Date(i.strValue).getTime();
                        return hubspot.operators[i.operator](s, r);
                    default:
            ...
            debounce: function(e, t, n) {
                ...
                return function() {
                    var a, r, o;
                    a = 1 <= arguments.length ? d.call(arguments, 0) : [];
                    o = this;
                    r = function() {
                        n || e.apply(o, a);
                        return i = null
            ...
            shouldRenderShell: function(e, t) {
                var n, i, a;
                return !e.shell && (!u.isShareableLink() && (!u.isCos(e) && (!(null == t || null == (n = t.scopes) || !n.renderShell) || !((null != t && null != (i = t.scopes) ? i.rawHtmlAccess : void 0) && u.shouldRenderFormRawHtml(e, null != t ? t.formData : void 0)) && (!e.hasOwnProperty("css") && !(null == t || null == (a = t.formData) || !a.themeName || t.formData.themeName === s.legacyThemeName)))))
            },
...
! function() {
    ...
    i = {
        ...
        getHsRecaptchaDomain: function(e) {
            ...
            return "qa" === t ? "https://js.hsformsqa.net" : "local" === t ? "https://js.hsformsqa.net" : "https://js.hsforms.net"
        },
            ...
            return new a((e = this, function(n) {
                ...
                o.emailValidationAndResub = r.fetch({
                    ...
                    onSuccess: function(t) {
                        ...
                        JSON.stringify(a) !== JSON.stringify(t) && p.report(new Error("Cached emailValidationAndResub different from actual"), {
                            cached: a,
                            actual: t
                        })
                    },
...
! function() {
    ...
    i = n.createClass({
        ...
        componentDidMount: function() {
            ...
            } else u = null != (r = s.getRecaptchaNamespace(this.props.useRecaptchaEnterprise)) && "function" == typeof r.render ? r.render(n.findDOMNode(this.refs.recaptchaTarget), {
            ...
            switch (this.props.fieldType) {
                ...
                case "singlelinetext":
                    if ("phone" === this.props.propertyName || "mobilephone" === this.props.propertyName) {
                        C = (null != (x = this.props.validation) ? x.data : void 0) ? this.props.validation.data.split(":") : [];
                        return u.createElement(s, u.__spread({}, b, {
                            validationData: C
                        }))
                    }
                    if ("email" === this.props.propertyName) {
                        C = !(null == (y = this.props.validation) || !y.data) && this.props.validation.data.split("|||");
                        I = !(null == (E = this.props.validation) || !E.useDefaultBlockList) && this.props.validation.useDefaultBlockList;
                ...
                case "number":
                    C = (null != (S = this.props.validation) ? S.data : void 0) ? this.props.validation.data.split(":") : [];
                ...
                case "range":
                    g = (C = (null != (k = this.props.validation) ? k.data : void 0) ? this.props.validation.data.split(":") : [])[0], m = C[1];
                ...
                case "rating":
                case "starRating":
                    C = (null != (T = this.props.validation) ? T.data : void 0) ? this.props.validation.data.split(":") : [];
...
! function() {
    var e, t, n, i, a, r, o, s, l, c, u, p, d, f, m, h, g = [].indexOf || function(e) {
        for (var t = 0, n = this.length; t < n; t++)
            if (t in this && this[t] === e) return t;
        return -1
    };
    ...
    n = s.createClass({
        ...
        submissionResponseHandler: function(e) {
            ...
            t = [this.formsDomain, d.getLocalDomain({
                env: this.props.env,
                hublet: this.props.hublet
            })];
            if ((e.origin !== c || document.location.origin === c) && m.isSubmissionResponseMessage(e, t)) {
                ...
                if (a === this.props.formId) {
                    ...
                    if (!(null != this.props.formInstanceId && (null != l ? l.hasOwnProperty("formInstanceId") : void 0) && (null != l ? l.formInstanceId : void 0) !== this.props.formInstanceId.toString())) {
                        ...
                        if (!u) {
                            null != (s = m.getRecaptchaNamespace(this.props.useRecaptchaEnterprise)) && s.reset(this.state.widgetId);
                            if (r) {
                                if ("RECAPTCHA_VALIDATION_ERROR" !== r || this.props.captchaEnabled) {
                                    if (this.isSubmissionNotAllowed(r)) return this.setGlobalError("SUBMISSION_NOT_ALLOWED");
                        ...
                        if (null != l ? l.redirectUrl : void 0) {
                            p = m.getDomainFromUrl(l.redirectUrl) === m.getDomainFromUrl(f.location.hostname) ? l.redirectUrl : n ? m.createCrossDomainTrackingUrl(l.redirectUrl, this.state.hsfp, this.state.hssc, this.state.hstc) : l.redirectUrl;
                        ...
                        }) : !this.state.inlineMessage && this.props.isVideo && null != (o = f.API) ? o.closeCta() : void 0
                    }
                }
            }
        },
        ...
        handleValidation: function(e) {
            ...
            for (r = 0, o = e.length; r < o; r++) {
                ...
                "BLOCKED_EMAIL" === c.formSubmissionValidationType ? a = i.BLOCKED_EMAIL : "REQUIRED_FIELD" === c.formSubmissionValidationType && (a = i.MISSING_REQUIRED_FIELDS);
                n[c.fieldName] = {
                    valid: !1,
        ...
        renderFieldGroups: function() {
            ...
            return hubspot.utils.map(this.state.fieldGroups, (n = this, function(i, a) {
                var r;
        ...
        renderRecaptcha: function() {
            ...
            if (this.props.captchaEnabled && null != (null != (e = m.getRecaptchaNamespace(this.props.useRecaptchaEnterprise, n)) ? e.render : void 0)) return s.createElement(l, {
                name: "recaptcha",
                errorClass: this.props.errorClass,
                groupErrors: this.props.groupErrors,
                errorMessageClass: this.props.errorMessageClass,
        ...
        handleChange: function() {
            return this.checkIfAllRequired() && this.state.errorType === i.MISSING_REQUIRED_FIELDS ? this.setState({
                errorType: void 0
            }) : this.checkIfEmailValid() && this.state.errorType === i.BLOCKED_EMAIL ? this.setState({
                errorType: void 0
            }) : void 0
        },
                ...
                return this.validateForm().done((n = this, function(e) {
                    ...
                    if (i = t && i) {
                        if (n.props.captchaEnabled) {
                            n.props.shell ? window.parent.hbspt.forms.executeRecaptcha[n.props.shellId]() : null != (a = m.getRecaptchaNamespace(n.props.useRecaptchaEnterprise)) && a.execute(n.state.widgetId);
                            return n.setState({
                                submitting: !1
                            })
                        }
        ...
        maybeSetGlobalError: function(e) {
            var t, n, a, r, o, s, l;
            l = [];
            for (n = 0, a = e.length; n < a; n++) !1 === (t = e[n]).valid ? (null != (r = t.errorTypes) ? r.indexOf("REQUIRED_FIELD") : void 0) > -1 ? l.push(this.setGlobalError(i.MISSING_REQUIRED_FIELDS)) : (null != (o = t.errorTypes) ? o.indexOf("INVALID_EMAIL") : void 0) > -1 || (null != (s = t.errorTypes) ? s.indexOf("BLOCKED_DOMAIN") : void 0) > -1 ? l.push(this.setGlobalError(i.BLOCKED_EMAIL)) : l.push(void 0) : l.push(void 0);
            return l
        },
        getFormEl: function() {
            var e;
        ...
        getFormAction: function() {
            ...
            return ("local" === hubspot.utils.getLocalStorage("SUBMISSIONS_ENV") ? d.getLocalDomain({
                env: this.props.env,
                hublet: this.props.hublet
            }) : this.formsDomain) + "/" + e
        },
        ...
        maybeRenderCookieReset: function() {
            ...
            if (t && e) return s.createElement("div", {
        ...
        renderSubmissionError: function() {
            var e;
            if (this.state.errorType) return s.createElement("div", {
            ...
            }, s.createElement("li", null, s.createElement("label", {
        ...
        render: function() {
            return this.hasThankYouMessage() && !this.props.isCos && (this.state.submitted || this.state.showInlineMessageInitially) ? this.isFreeShareable() ? s.createElement("div", {
            ...
            }) : this.hasThankYouMessage() && this.props.isCos && (this.state.submitted || this.state.showInlineMessageInitially) ? this.generateThankYouMessageFragment() : document.querySelector("form " + this.props.formTarget) ? s.createElement("div", {
...
! function() {
    ...
    r = {
        ...
        renderForm: function(i, r, u, p, d, f, m, h, g, v, b, x, y, E, S, k) {
            var T, I, C, D, _, N, R, O, w, M, L, A, F, j, P, B, V, z, U, H, q, G, K, W, Y, Q, J, Z, X, $, ee, te, ne, ie, ae;
            ...
            ee = hubspot.utils.shouldRenderFormRawHtml(i, r) && (null != f ? f.rawHtmlAccess : void 0);
            ...
            try {
                _ = hubspot.utils.mergeStyles(O, R)
            } catch (e) {
                _ = {}
            }
            M && (_ = {});
            ...
            hubspot.utils.injectCss(D, J, h, ne, _);
            null != (A = hubspot.utils.extend({}, i)).inlineMessage && (A.inlineMessage = !0);
            ...
            I = t.render(t.createElement(e, {
                ...
                cssClass: i.cssClass || (null != (U = i.formData) ? U.cssClass : void 0) || r.cssClass || "",
                ...
                locale: i.locale || hubspot.utils.getlocaleCode(null != (K = i.validationOptions) ? K.lang : void 0) || o(r) || "en",
            ...
            null != (ae = i.shell ? window.parent : window) && null != (Y = ae.HSFR) && Y.FORM_COMPONENTS.push(I);
            return I
        }
    };
    null == hubspot.form && (hubspot.form = {});
...
! function() {
    ...
    a = function(e, t) {
        var n, i, a, r;
        if (e.target) {
            if (!(a = document.querySelector(e.target))) {
            ...
            (a = document.createElement("div")).className = "hs-form";
            r = "hs-form-" + e.shellId;
            a.setAttribute("id", r);
            f.currentScript.insertAdjacentHTML("afterend", a.outerHTML);
    ...
    o = {
        renderRecaptcha: function(n, i, a) {
            ...
            e.fetchRecaptcha(n, function() {
                ...
                l = null != (r = f.getRecaptchaNamespace(a)) ? r.render(document.getElementById(u), e, !0) : void 0;
